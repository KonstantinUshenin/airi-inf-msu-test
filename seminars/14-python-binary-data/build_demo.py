...
md("""### Z-нормализация: столбцы в одном масштабе
...
md("""Одна засада: если столбец постоянный, его стандартное отклонение равно
...
md("""Несжатый NPZ больше NPY по понятной причине: внутри не только измерения,
...
md("""### Пропуски и нормализация: что ещё проверить
