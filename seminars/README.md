...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | сентябрь | Jupyter Notebook. Практика по визуализации | jupyter, магии ноутбука `%`/`%%`, numpy (векторизация, broadcasting), matplotlib, plotly, colab | **№1: подключиться к учебному серверу по SSH** и сдать оттуда ноутбук с графиком по своим данным | Dmitrii | Максим |
