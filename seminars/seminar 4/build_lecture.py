...
md("![Цепочка хэшей коммитов](images/05-hash-chain.svg)")
...
![Три зоны git](images/01-three-zones.svg)
...
![reset против revert](images/06-reset-vs-revert.svg)""")
...
![Ветка и HEAD — указатели](images/02-branch-pointers.svg)
...
![Общий предок и коммит слияния](images/03-merge-base.svg)""")
...
![Форк, upstream, origin и локальный клон](images/04-fork-remotes.svg)
...
![Бинарный поиск сломавшего коммита](images/07-bisect.svg)
